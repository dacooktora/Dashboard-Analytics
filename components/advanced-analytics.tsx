...
export function AdvancedAnalytics() {
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card className="p-6 border-none shadow-md bg-card/50 backdrop-blur">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={data.cohortData} margin={{ top: 10, right: 55, left: 10, bottom: 0 }}>
              <defs>
  ...
  tickFormatter={(val) => formatCurrency(val)}  // ✅ Pake formatCurrency
  width={100}  // ✅ Lebar ditambah biar muat angka panjang
/>
              <Tooltip
                contentStyle={{
                  backgroundColor: "hsl(var(--popover))",
